...
# 1. cut out the subject (ponytail: u2netp ~25MB vs u2net ~176MB; swap to u2net if quality insufficient)
_session = new_session("u2netp")
cut = remove(Image.open(INP).convert("RGBA"), session=_session)

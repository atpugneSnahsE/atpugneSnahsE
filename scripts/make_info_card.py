...
# ===========================================================================
HOST = "eshan"   # shown as  eshan@github  in the header
...
ROWS = [
    ...
    ("kv", "Backend", "Node, Python, PostgreSQL"),
    ("kv", "Tools", "Docker, Git, Linux"),
    ("kv", "AI / ML", "LangChain, OpenAI, RAG"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built production-grade full-stack apps"),
    ("bul", "Open-source contributor"),
    ("bul", "Automation & devtooling enthusiast"),
]
